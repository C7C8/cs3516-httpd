...
const char *gengetopt_args_info_usage = "Usage: httpd [-tdp] [-k]";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->port_help = gengetopt_args_info_detailed_help[10] ;
  args_info->kill_help = gengetopt_args_info_detailed_help[13] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVvt:dp:k", long_options, &option_index);
