...
the only flags needed for g++ are -pthread and -std=c++0x.
...
Interesting note: Until I ran `sed -i "s/nullptr/NULL/g"`, neither of these programs could be compiled on rambo.wpi.edu.
I guess that's what you get when you use software that's 8 years old.
