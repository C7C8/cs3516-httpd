/*
  ...
  gengetopt --output-dir httpc --unamed-opts
...
const char *gengetopt_args_info_purpose = "Simple HTTP client";

const char *gengetopt_args_info_usage = "Usage: httpc [-vp] URL port";

const char *gengetopt_args_info_versiontext = "Created by crmyers for A17-CS3516 at WPI";

const char *gengetopt_args_info_description = "Simple HTTP client, will connect to an appropriate server, submit its request,\nand print whatever the server sends.";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "  Print out HTTP queries and responses alongside connection info and the data\n  returned by the server",
  "  -p, --print-rtt      Print RTT",
  "  Print the RTT for accessing the URL on the terminal before the server's\n  response",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->print_rtt_help = gengetopt_args_info_detailed_help[5] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->print_rtt_given)
    write_into_file(outfile, "print-rtt", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVvp", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'p':	/* Print RTT.  */
          ...
          if (update_arg( 0 , 
               0 , &(args_info->print_rtt_given),
              &(local_args_info.print_rtt_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "print-rtt", 'p',
              additional_error))
            goto failure;
