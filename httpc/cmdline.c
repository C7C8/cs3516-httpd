...
const char *gengetopt_args_info_purpose = "Simple HTTP client constructed for CS 3516";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "  Prints out HTTP queries and responses alongside connection info and the data\n  returned by the server",
